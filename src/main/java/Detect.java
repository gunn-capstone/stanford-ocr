...
public class Detect {
     ...
     * @throws IOException on Input/Output errors.
     */
    private static void argsHelper(String[] args, PrintStream out) throws Exception, IOException {
        if (args.length < 1) {
            out.println("Usage:");
            out.print(
    ...
    private static void detectFaces(String filePath, PrintStream out) throws Exception, IOException {
    ...
    private static void detectFacesGcs(String gcsPath, PrintStream out) throws Exception,
            IOException {
        List<AnnotateImageRequest> requests = new ArrayList<>();
